...
userpool_id = "us-west-2_MyUserPoolId1234"
client_id = "MyClientId"
#this can be either the param name to read from (e.g. /dev-RecipeStack/bff/client_secret) or the actual secret value prefixed with "secret:"
client_secret_param = "secret:MyClientSecret"
authority = "https://cognito-idp.us-west-2.amazonaws.com/us-west-2_MyUserPoolId1234"
